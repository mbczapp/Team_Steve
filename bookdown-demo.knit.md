...
<!--chapter:end:02-whatIsAI.Rmd-->

# AI Tools for Job Searching

<!--chapter:end:03-jobSearch.Rmd-->
...
<!--chapter:end:04-resumeCoverLetter.Rmd-->

# Student Practice Interviews

<!--chapter:end:05-practiceInterviews.Rmd-->

# Automated Applications

<!--chapter:end:06-automatedApplication.Rmd-->

# What Are Applicant Tracking Systems (ATS)?

<!--chapter:end:07-ATS.Rmd-->

# Recruiting Chatbots

<!--chapter:end:08-chatbots.Rmd-->

# Resume and Cover Letter Screening

<!--chapter:end:09-resumeCoverLetterScreening.Rmd-->

# Video Interview Assessments

<!--chapter:end:10-interviewAssessment.Rmd-->

# Skill Assessments

<!--chapter:end:11-skillAssessment.Rmd-->

# Predicting Candidates' Success

<!--chapter:end:12-predictiveAnalytics.Rmd-->
